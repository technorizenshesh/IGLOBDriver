...
/**
 * Created by technorizen on 18/12/17.
 */
...
public class RideBean {
    ...
    public String getDrivercardetail() {
        return drivercardetail;
    }

    public void setDrivercardetail(String drivercardetail) {
        this.drivercardetail = drivercardetail;
    }
    ...
    public int getJoin_seen() {
        return join_seen;
    }

    public void setJoin_seen(int join_seen) {
        this.join_seen = join_seen;
    }
